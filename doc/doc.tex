...
\figref{Fig:cost1}, \figref{Fig:cost10}, \figref{Fig:cost20}にinflation\_radiusが同じ値のときに, 
...
update\_frequency, inflation\_radius, cost\_scaling\_factor, resolutionといったパラメータはlocal\_costmapと同様の意味を持つ. 
