\section{ドキュメントの構成}
作成したドキュメント(\url{https://github.com/open-rdc/nav_tuning_guide})は以下の要素から構成されている. 
作成にあたってはROS WikiのNavigationページを参考にした.
...
\figref{Fig:doc}にドキュメントのスクリーンショットを示す. 
\begin{figure}[H]
  \centering
 \includegraphics[keepaspectratio, scale=0.17]
      {images/screenshot.png}
 \caption{Screenshot of documents}
 \label{Fig:doc}
\end{figure}
