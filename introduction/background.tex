...
{ROS Navigation Stackのパラメータの調整方法に関する\\[0pt]\hspace{2.25em}公開情報}
...
\begin{figure}[hbtp]
 ...
 \caption{Parameters for TrajectoryPlannerROS(souce: \cite{siryo_3})}
...
\begin{figure}[hbtp]
 ...
 \caption{Parameters for global costmap(souce: \cite{siryo_3})}
...
\begin{figure}[hbtp]
 ...
 \caption{Parameter for local costmap(souce: \cite{siryo_3})}
 \label{Fig:param_example_3}
\end{figure}

\newpage
\section{目的}
本論文では, ロボットにおけるROS Navigation stackを用いたナビゲーションの調整手順を体系化し, 調整方法の一例を示すことを目的とする. 
...
4章では津田沼チャレンジによる実験でドキュメントの有用性を検証する. 

5章ではつくばチャレンジによる実験でドキュメントの有用性を検証する. 
